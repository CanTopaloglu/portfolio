...
function getSkills() {
    ...
    fetch("https://localhost:7298/api/Home/GetSkills")
        .then(res => res.json())
        .then(data => {
            let text = "";
...
async function getProjects() {
    var res = await fetch("https://localhost:7298/api/Home/GetProjects").then(res=> res.json());
...
async function getExperience() {
    var res = await fetch("https://localhost:7298/api/Home/GetExperiences").then(res=> res.json());
...
async function getSocialMedias(){
    var res = await axios.get("https://localhost:7298/api/Home/GetSocialMedias")
